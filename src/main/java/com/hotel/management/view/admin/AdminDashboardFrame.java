...
public class AdminDashboardFrame extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        sidebar.setMinimumSize(new Dimension(200, 700));
        ...
        viewReportsBtn.addActionListener(e -> cardLayout.show(mainContentPanel, "ViewReports"));
    ...
    private JPanel createDropdownMenu(String title, String iconType, String[] subItemTexts, String[] subItemCardNames) {
        ...
        for (int i = 0; i < subItemTexts.length; i++) {
            ...
            subBtn.setMinimumSize(new Dimension(180, 30));
