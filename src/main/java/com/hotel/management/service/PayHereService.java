...
public class PayHereService {
    ...
    private static final String MERCHANT_ID = dotenv.get("PAYHERE_MERCHANT_ID");
    private static final String MERCHANT_SECRET = dotenv.get("PAYHERE_MERCHANT_SECRET");
    private static final boolean SANDBOX_MODE = Boolean.parseBoolean(dotenv.get("PAYHERE_SANDBOX_MODE", "true"));
    private static final String CURRENCY = dotenv.get("PAYHERE_CURRENCY", "LKR");
    private static final String RETURN_URL = dotenv.get("PAYHERE_RETURN_URL", "http://localhost/payment/return");
    private static final String CANCEL_URL = dotenv.get("PAYHERE_CANCEL_URL", "http://localhost/payment/cancel");
    private static final String NOTIFY_URL = dotenv.get("PAYHERE_NOTIFY_URL", "http://localhost/payment/notify");
